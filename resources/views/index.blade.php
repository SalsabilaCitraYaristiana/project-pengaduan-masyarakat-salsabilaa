...
<body>
    <header>
        {{-- kalau udah login button yg dimunculin button ke halaman data--}}
        @if (Auth::check())
        ...
        @endif
        {{-- kalau dia belum login, button yang dimunculin button buat login --}}
        @else
    ...
    <section class="form-container">
        ...
        <div class="card laporan-card">
            ...
            <div style="display: flex; justify-content: flex-end; margin-top: 10px"> {!! $reports->links() !!} </div>
        </div>
    </section>
